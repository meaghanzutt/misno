...
export function ExperienceCard({ experience }: { experience: Experience }) {
  ...
  return (
    <Link
      to={`/app/experiences/${experience.id}`}
      className="group block rounded-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest focus-visible:ring-offset-4"
      aria-label={`View ${experience.title}`}
    >
      <Card className="experience-card p-0">
